...
{
    public partial class PELUQUERIADBContext
    {
        private IPELUQUERIADBContextProcedures _procedures;

        public virtual IPELUQUERIADBContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new PELUQUERIADBContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IPELUQUERIADBContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class PELUQUERIADBContextProcedures : IPELUQUERIADBContextProcedures
    {
        private readonly PELUQUERIADBContext _context;

        public PELUQUERIADBContextProcedures(PELUQUERIADBContext context)
        {
            _context = context;
        }
